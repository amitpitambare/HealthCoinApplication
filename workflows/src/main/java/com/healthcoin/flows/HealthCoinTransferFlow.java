...
@StartableByRPC
public class HealthCoinTransferFlow extends FlowLogic<SignedTransaction> {
	...
	public HealthCoinTransferFlow(String tokenName, Party holderName, Long quantity, Party recipient) {
