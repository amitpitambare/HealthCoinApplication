...
import com.healthcoin.state.HealthCoinTokenState;
...
@StartableByRPC
@StartableByService
public class HealthCoinIssuanceFlow  extends FlowLogic<SignedTransaction>{
	...
	public HealthCoinIssuanceFlow(String tokenName, Long quantity, Party recipient) {
